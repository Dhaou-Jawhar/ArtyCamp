...
/* public void ajouterUser(Utilisateur u ){
    ...
    public Reclamation(int id, Date date, String msg, String object, Utilisateur user) {
        this.id = id;
        this.date = date;
        this.msg = msg;
        this.object = object;
    ...
    public Reclamation(Date date, String msg, String object, Utilisateur user) {
        this.date = date;
        this.msg = msg;
        this.object = object;
        this.user = user;
    ...
    public Reclamation(String msg, String object, Utilisateur user) {
        this.msg = msg;
        this.object = object;
        this.user = user;
    }
    ...
    public String toString() {
        return "Reclamation{" + "id=" + id + ", date=" + date + ", msg=" + msg + ", object=" + object + ", user=" + user + '}';
    }*/
